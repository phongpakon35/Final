...
<html>																									
 ...
 <body>
 		...
 		<div class="site-wrapper" action="<?php echo base_url('index.php/delete');?>">
		  <div class="site-wrapper-inner">
		    <div class="cover-container">
		      ...
		      <div class="inner cover" >
		        <form class="form-horizontal" action="<?php echo base_url('index.php/Delete/checkdelete');?>" method="post" >
				  <div class="form-group">
				   
				  <div class="form-group">
				    <label for="inputPassword3" class="col-sm-2 control-label">รหัสสินค้า</label>
				    <div class="col-sm-5">
				      <input type="text" name="productCode" class="form-control" id="inputPassword3" placeholder="รหัสสินค้า">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="col-sm-offset-2 col-sm-2">
				      <button type="submit" class="btn btn-default" >ลบสินค้า</button>
